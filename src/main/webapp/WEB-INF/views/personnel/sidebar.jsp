...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container">
    ...
    <p class="w3-text-grey" id="id">${requestScope.id}</p>
  </div>
  ...
  <div class="w3-bar-block">
	...
	<c:forEach var="vo" items="${clist }">
      ...
      <a href="<c:url value="/${sessionScope.id }/list"/>" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-bars fa-fw w3-margin-right"></i>Video</a>
  </div>
