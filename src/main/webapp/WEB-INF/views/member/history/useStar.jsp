...
<div class="w3-main" style="margin: 60px auto 0 auto; width: 960px;">
	...
	<div>
		...
		<a href="<c:url value='/member/history/useStar'/>" class="w3-bar-item w3-button" style="text-decoration: none;background-color: #cccccc;">선물한 별사탕내역</a>
	...
	<!-- 페이징 -->
		...
		<c:choose>
			<c:when test="${pu.startPageNum<pu.totalPageCount }">
				<a href="<c:url value='/member/history/useStar?pageNum=${pu.totalPageCount }'/>" class="w3-bar-item w3-button w3-hover-black">»</a>
			</c:when>
			<c:otherwise>
				<a href="#" class="w3-bar-item w3-button w3-hover-black">»</a>
			</c:otherwise>
