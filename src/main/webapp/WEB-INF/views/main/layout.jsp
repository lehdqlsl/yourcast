	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#preRecv a").on('click',function(){
				...
				$("#recvlistB").empty();
				$.ajax({
					url:"<c:url value='/main/history/recvStarPaging'/>",
				...
				$("#pagingRecv").empty();
				$.ajax({
					url:"<c:url value='/main/history/recvStarPagingPre'/>",
					data:{"pageNum":pageNum},
					success:function(data){
			...
			$("#nextRecv a").on('click',function(){
				...
				$("#pagingRecv").empty();
				$.ajax({
					url:"<c:url value='/main/history/recvStarPagingNext'/>",
					data:{"pageNum":pageNum},
					success:function(data){
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#preEx a").on('click',function(){
				...
				$("#exlistB").empty();
				$.ajax({
					url:"<c:url value='/main/history/exStarPaging'/>",
					data:{"pageNum":pageNum},
					success:function(data){
				...
				$("#pagingEx").empty();
				$.ajax({
					url:"<c:url value='/main/history/exStarPagingPre'/>",
					data:{"pageNum":pageNum},
					success:function(data){
						for(var i=data-4;i<=data;i++){
			...
			$("#nextEx a").on('click',function(){
				...
				$("#pagingEx").empty();
				$.ajax({
					url:"<c:url value='/main/history/exStarPagingNext'/>",
					data:{"pageNum":pageNum},
					success:function(data){
						for(var i=pageNum;i<=data;i++){
							$("<a href='#' class='pagingE'>" + i + "</a>&nbsp;").appendTo("#pagingEx").css('margin','4px').on('click',function(){
