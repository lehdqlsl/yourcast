...
<!-- 파비콘 -->
<link rel="shortcut icon" href="/Fulfilling/images/apple.ico"/>
<meta name="description"
   content="A free HTML5/CSS3 template made exclusively for Codrops" />
<meta name="keywords"
   content="html5 template, css3, one page, animations, agency, portfolio, web design" />
<meta name="author" content="" />
    <link rel="stylesheet" href="/common_v3.css">
    <style type="text/css">
        body{margin:0;padding:0;background-color:#fff;text-align:center}
        hr{display:none}
        h1,h2,h3,h4,h5,dl,dt,dd,ul,li,ol,th,td,p,blockquote,form,fieldset,legend{margin:0;padding:0}
        body,th,td{font-size:12px;font-family:"돋움",Dotum,AppleGothic,sans-serif;color:#333}

        #DAUMCOMMON_WRAP,#DAUMCOMMON_FOOTER{position:relative;width:978px;margin:0 auto;text-align:left}
        #DAUMCOMMON_WRAP{margin-top:150px}
        #DAUMCOMMON_FOOTER{color:#666666;text-align:center;font-size:11px;line-height:140%;margin-bottom:10px}
        #DAUMCOMMON_FOOTER a{color:#666666}
        #DAUMCOMMON_WRAP ul,#DAUMCOMMON_WRAP ol,#DAUMCOMMON_WRAP li{list-style:none}
...
<div id="DAUMCOMMON_WRAP">
        <div id="ContentsWrap">
            ...
            <p>
                본 약관은 서비스 이용자가 주식회사 Your BroadCast...(이하 “회사”라 합니다)가 제공하는 온라인상의 인터넷 서비스(이하 “서비스”라고 하며, 접속 가능한 유∙무선 단말기의 종류와는 상관없이 이용 가능한 “회사”가 제공하는 모든 “서비스”를 의미합니다. 이하 같습니다)에 회원으로 가입하고 이를 이용함에 있어 회사와 회원(본 약관에 동의하고 회원등록을 완료한 서비스 이용자를 말합니다. 이하 “회원”이라고 합니다)의 권리•의무 및 책임사항을 규정함을 목적으로 합니다.
            </p>
            ...
            <ol class="list_terms">
                ...
                <li>
                    <span class="txt_num">②</span>
                    <p class="txt_clause">회사가 제공하는 유료서비스에 대한 이용요금의 결제 방법은 핸드폰결제, 신용카드결제, 일반전화결제, 계좌이체, 무통장입금, Your BroadCast...캐쉬 결제 등이 있으며 각 유료서비스마다 결제 방법의 차이가 있을 수 있습니다.</p>
                </li>
                <li>
                    <span class="txt_num">③</span>
            ...
            <div id="DAUMCOMMON_FOOTER">
                ...
                Copyright ⓒ <a href="" target="new">Your BroadCast... Corp.</a> All rights reserved.<br/>
            </div>
        </div>
        <!-- 2015-11-26 수정 끝 -->
